                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php 
                                            $query =    "SELECT *, tbl_logs.timestamp FROM `tbl_logs` 
                                                        INNER JOIN tbl_add_item ON tbl_logs.item_id=tbl_add_item.item_add_id 
                                                        INNER JOIN tbl_items ON tbl_add_item.item_id=tbl_items.item_id 
                                                        INNER JOIN tbl_users ON tbl_add_item.user_id=tbl_users.user_id 
                                                        ...
                                                        ORDER BY tbl_logs.timestamp DESC";
                                ...
                                <form style="Padding: 15px"; action="pdf/print.php"><button type="submit" class="btn btn-primary">Print PDF</button></form>  
                            </div>
                        </div>
                    </div>
                </div>
