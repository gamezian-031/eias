            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Borrow Status</h4>
                        <div class="ms-auto text-end">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Borrow Status</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                            ...
                                            while($row = $result->fetch_assoc()){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        if($row['status'] == 1){
                                                            ?>
                                                            <a href="functions/cancel.php?itemid=<?php echo $row['item_add_id']; ?>&&userid=<?php echo $userid; ?>"><button class="btn btn-danger text-white">Cancel</button></a>
                                                            <?php
                                                        }else{
                                                            ?>
                                                            <button class="btn btn-danger text-white" disabled="disabled">Cancel</button>
                                                            <?php
                                                        }
                                                        ?>
