        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <form class="form-horizontal" method="post" action="functions/returnScan.php">
                                <div class="card-body">
                                    <?php 
                                    if(@$_GET['error'] == 1){
                                        ?>
                                    ...
                                    ?>
                                    <h4 class="card-title"><center>Return Item</center></h4>
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            while($row = $result->fetch_assoc()){
                                                ...
                                                <div class="col-md-12">
                        		        			...
                        		        			<textarea class="form-control" readonly><?php echo $row['item_description']; ?></textarea>
                        		        		</div>
                                                <?php
                                            }
                                            ?>
