            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">View Cart Borrow</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="center">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title mb-0">View Borrow</h5>
                            </div>
                            <?php 
                            if(@$_GET['error'] == 1){
                                ?>
                            ...
                            <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            while($row = $result->fetch_assoc()){
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="functions/deleteCart.php?id=<?php echo $row['item_add_id']; ?>&&itemid=<?php echo $row['item_id']; ?>&&item_quantity=<?php echo $row['borrow_quantity']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a></td>
                                                </tr>
                                                <?php
                                            }
                                            ?>
                                    ...
                                    <!-- <div class="form-group row">
                                        <label for="fname"
                                            class="col-sm-2 text-end control-label col-form-label">From</label>
                                        <div class="col-sm-4">
                                            <input type="date" class="form-control" id="from"
                                                placeholder="Date From" name="from" >
                                        </div>

                                        <label for="fname"
                                            class="col-sm-1 text-end control-label col-form-label">To</label>
                                        <div class="col-sm-4">
                                            <input type="date" class="form-control" id="from"
                                                placeholder="Date To" name="from" >
                                        </div>
                                    </div> -->
                                </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <br>
                                        <br>
                                        <span style="color:red; font-weight: bold;">Borrower agrees to use the Equipment for academic, research, government or non-profit use only, and not for any commercial use or application.</span>
                                        </p>
                                    </div>
