                        ...
                        <div class="card">
                            <form class="form-horizontal" method="post" action="functions/returnItem.php">
                                <div class="card-body">
                                    ...
                                    ?>
                                    <h4 class="card-title">Return Info</h4>
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            $query =    "SELECT item_name,category_name,brand_name,location_name,borrow_quantity,status,DATEDIFF(curdate(), 
                                                        DATE_FORMAT(update_date,'%Y-%m-%d')) as days,tbl_add_item.timestamp FROM `tbl_add_item` 
